...
con =async function main() {
    await mongoose.connect('mongodb+srv://honeydixit63_db_user:VN0YAg8molg8TtDB@cluster0test.thaesti.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0Test');
